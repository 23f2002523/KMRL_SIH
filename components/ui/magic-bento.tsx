...
import { Train, BarChart3, Users, Settings, Zap, Shield } from 'lucide-react';
import './magic-bento.css';

const DEFAULT_PARTICLE_COUNT = 12;
const DEFAULT_SPOTLIGHT_RADIUS = 300;
const DEFAULT_GLOW_COLOR = '16, 185, 129'; // Emerald/teal color for KMRL theme
...
const cardData = [
  {
    ...
    description: 'Real-time train performance monitoring',
    label: 'Insights',
    icon: BarChart3
  },
  {
    ...
    description: 'Centralized control and overview',
    label: 'Control',
    icon: Train
  },
  {
    ...
    description: 'Seamless operator coordination',
    label: 'Teamwork',
    icon: Users
  },
  {
  ...
  },
  {
    ...
    description: 'Connect all KMRL systems',
    label: 'Connectivity',
    icon: Settings
  },
  {
